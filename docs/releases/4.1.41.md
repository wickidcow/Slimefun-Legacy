...
This latest sample is from the prior live test JAR and therefore does not yet include the final lazy Enhanced Auto Crafter match-mode cache. That final optimization is being release-gated by the full CI matrix rather than requiring another immediate production restart.
