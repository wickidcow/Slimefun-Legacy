...
- **Enable Legacy Pack Sender** — opens a confirmation before turning only Slimefun Legacy pack delivery on; it does not change item models.
...
- **Disable Legacy Pack Sender** — opens a confirmation before turning only Slimefun Legacy pack delivery off; it does not change item models.
