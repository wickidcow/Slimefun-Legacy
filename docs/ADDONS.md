...
- [Machine Recipe Provider API](MACHINE_RECIPE_PROVIDER_API.md)
- [Machine Input Fill Adapter API](MACHINE_INPUT_FILL_ADAPTER_API.md)
- [Platform Compatibility API](PLATFORM_COMPATIBILITY_API.md)
