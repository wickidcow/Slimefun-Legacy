 ...
 * the same Bukkit plugin. Validation may perform asynchronous database reads, but must remain read-only.
 * Validators must not mutate ItemStacks, databases, worlds, chunks or player state.</p>
 */
@SlimefunAPI
