...
public enum BeaconPlusEffect {
    ...
    EXPERIENCE_BOOSTER("experience_booster", "Experience Booster", Material.EXPERIENCE_BOTTLE, "Increase earned experience in range."),
    ...
    FIRE_EXTINGUISHER("fire_extinguisher", "Fire Extinguisher", Material.WATER_BUCKET, "Extinguish burning players in range."),
