...
public final class Magic8BallItems {
    ...
    public static final ItemGroup ITEM_GROUP = new ItemGroup(
            Objects.requireNonNull(NamespacedKey.fromString("magic8ball:main_group")),
            new CustomItemStack(PlayerHead.getItemStack(PlayerSkin.fromBase64(HEAD_TEXTURE)), "&eMagic 8 Ball"));
