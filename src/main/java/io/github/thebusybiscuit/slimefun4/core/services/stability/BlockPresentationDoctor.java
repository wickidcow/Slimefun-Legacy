...
final class BlockPresentationDoctor {
    ...
    private void inspectStoredIdentity(Location location, ItemDoctorReport report) {
        ...
        // Declared mappings are authoritative migration evidence. A live alias is worth
        // diagnosing too, but remains non-authoritative until an addon publishes a mapping/provider.
