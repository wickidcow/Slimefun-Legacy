...
class SlimefunTabCompleter implements TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, Command cmd, String label, String[] args) {
        if (args.length == 1) {
            ...
            if (args[0].equalsIgnoreCase("give")) {
                ...
                return createReturnList(
                        List.of("status", "list", "unknown", "plan", "providers", "scan", "execute", "schemas", "machines"),
                        args[2]);
            ...
            return createReturnList(List.of("status", "scan", "execute", "blocks", "storage"), args[3]);
                ...
                && args[0].equalsIgnoreCase("doctor")
                && args[1].equalsIgnoreCase("migrations")
                && args[2].equalsIgnoreCase("machines")) {
            return createReturnList(List.of("status", "providers", "scan", "execute"), args[3]);
        } else if (args.length == 4
                && args[0].equalsIgnoreCase("doctor")
                && args[1].equalsIgnoreCase("migrations")
            ...
            return createReturnList(getMachineMigrationProviders(), args[4]);
        } else if (args.length == 5
                && args[0].equalsIgnoreCase("doctor")
                && args[1].equalsIgnoreCase("migrations")
                && args[2].equalsIgnoreCase("schemas")
            ...
            return Collections.emptyList();
                ...
                && args[2].equalsIgnoreCase("machines")
                && args[3].equalsIgnoreCase("execute")) {
            // Live-machine fingerprints are short-lived, single-use state; never suggest cached tokens here.
            return Collections.emptyList();
        } else if (args.length == 6
                && args[0].equalsIgnoreCase("doctor")
                && args[1].equalsIgnoreCase("migrations")
    ...
    @Nonnull
    private List<String> getMachineMigrationProviders() {
        return Bukkit.getServicesManager().getRegistrations(LegacyMachineMigrationProvider.class).stream()
                .filter(registration -> registration.getPlugin() != null && registration.getPlugin().isEnabled())
                .map(registration -> registration.getPlugin().getName())
                .distinct()
                .sorted(String.CASE_INSENSITIVE_ORDER)
