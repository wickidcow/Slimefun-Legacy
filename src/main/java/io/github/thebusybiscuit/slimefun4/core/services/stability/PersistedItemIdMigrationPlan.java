...
/** Short-lived authorization for exact legacy Slimefun item-ID rewrites in unloaded persisted inventories. */
public final class PersistedItemIdMigrationPlan {
