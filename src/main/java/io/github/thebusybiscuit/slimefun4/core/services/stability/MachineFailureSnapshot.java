...
public final class MachineFailureSnapshot {
    ...
    public long getFailuresObserved() { return failuresObserved; }
    public long getSuppressedReports() { return suppressedReports; }
    public long getFirstFailureMillis() { return firstFailureMillis; }
    public long getLastFailureMillis() { return lastFailureMillis; }
    public long getPausedUntilMillis() { return pausedUntilMillis; }
    public boolean isPaused(long nowMillis) { return pausedUntilMillis > nowMillis; }
