...
def main() -> int:
    ...
    require(listener, '"↑ "', "lever-up ON visual marker")
    require(listener, '"↓ "', "lever-down OFF visual marker")
    require(listener, '"Area Preview: "', "area-preview menu label")
    require(listener, 'enabled ? "ON" : "OFF"', "explicit ON/OFF menu state")
