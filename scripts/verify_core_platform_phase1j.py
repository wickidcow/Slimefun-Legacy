...
def phase_at_least_1j(phase: object) -> bool:
    """Allow Phase 1J or any later Phase 1 letter without weakening Phase 1J checks."""
    match = re.fullmatch(r"Core Platform Phase 1([A-Z])", str(phase))
    return match is not None and match.group(1) >= "J"
...
def main() -> int:
    ...
    try:
        ...
        req(phase_at_least_1j(support.get("phase")), "Support contract phase must be Phase 1J or later", failures)
