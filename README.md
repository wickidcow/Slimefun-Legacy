...
Current release: **4.1.56 — Doctor GUI, resource-pack recovery & guide search**. ·
...
Slimefun Legacy 4.1.56 supports **Velocity modern forwarding** on the primary Paper 26.2 production line. Proxy CI uses a real Minecraft 26.2 client session to verify that the UUID presented through Velocity reaches Bukkit/Slimefun unchanged and that Slimefun research remains attached to the same profile after disconnect/reconnect.
